  ...
  const confirmDeleteProduct = (uuid) => {
    confirmDialog({
      ...
      accept: () => {
        ...
        axiosInstance.delete(`store/category/${uuid}/delete/`).then(() => {
          setCategories(
            categories.filter((category) => category.uuid !== uuid)
          );
        });
      },
    });
    ...
    return (
      <>
        <Button
          ...
          severity="secondary"
          onClick={() =>
            navigate(`/categories/edit/${rowData.uuid}`, {
              state: { category: rowData },
            })
          }
        />
        <Button
          ...
          severity="secondary"
          onClick={() =>
            navigate(`/categories/show/${rowData.uuid}`, {
              state: { category: rowData },
            })
          }
        />
