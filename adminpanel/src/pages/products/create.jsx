...
export const ProductCreate = () => {
    ...
    const onSubmit = async (data) => {
        ...
        const response = await axiosInstance.post(`store/product/create/`, JSON.stringify({
            name: data.name,
    ...
    return (
        ...
        >
            <Helmet>
                <title>Dearest. | Create product</title>
            </Helmet>
                        ...
                        render={({ field, fieldState }) => (
                            <div className="mb-1">
                                ...
                                <Dropdown
                                    ...
                                    options={categories.map((category) => (`(${category.uuid}) - ${category.name}`))}
